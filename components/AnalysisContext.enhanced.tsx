...
interface AnalysisContextType {
  ...
  debouncedUserDescription: string; // Exposed for debugging/display
...
export const AnalysisProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Debounce user description to reduce re-renders
  // Analysis will use the debounced value
  ...
  const performAnalysis = useCallback(
    async (isFollowUp: boolean = false) => {
      ...
      try {
        // Use debounced description for analysis
        const result = await analyzePlantHealth(
          imageFile,
          debouncedUserDescription, // Use debounced value
          selectedLanguage,
          userLocation,
          weatherData,
          environmentalData,
    ...
    [
      imageFile,
      debouncedUserDescription, // Changed from userDescription
      selectedLanguage,
      userLocation,
      weatherData,
      environmentalData,
